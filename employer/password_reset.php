...
if ($_POST) {
    ...
    if ($password != $passwordconf) {
        ...
        $query = "UPDATE employers SET password = '$password', temphash = null;";
        //$query = "UPDATE employers SET password = '$password';";
        //echo $query;
...
if(isset($_REQUEST['id'])) {
    ...
    $query = "SELECT * FROM employers WHERE temphash = '$hashcheck';";
...
<html>
    ...
    <body>
        ...
        <?php } elseif ($changed) { echo "hello!";}
         else { header('Refresh: 5;  index.php'); }?>
